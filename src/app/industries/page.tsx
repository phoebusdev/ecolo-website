          ...
          <div className="text-center">
            ...
            >
              ...
              <div className="flex items-center bg-white px-6 py-3 rounded-full shadow-md">
                ...
                <span className="font-medium text-gray-700">Proven ROI</span>
              </div>
              <div className="flex items-center bg-white px-6 py-3 rounded-full shadow-md">
                <FiUsers className="h-5 w-5 text-blue-600 mr-2" />
                <span className="font-medium text-gray-700">Community Relations</span>
              </div>
            </motion.div>
          </div>
        </div>
                  ...
                  <div className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border border-gray-100 hover:border-primary/20 cursor-pointer h-full">
                    ...
                    <div className="flex items-center mb-6">
                      ...
                      <div className="flex-1">
                        <h3 className="text-2xl font-heading font-bold text-gray-900 group-hover:text-primary transition-colors mb-2">
                          {industry.name}
                        </h3>
                    ...
                    <div className="space-y-4 mb-6">
                      <div className="bg-red-50 rounded-lg p-4">
                        <div className="text-sm font-semibold text-red-800 mb-1">Common Challenges</div>
                        <div className="text-red-700 text-sm">{industry.challenges}</div>
                      </div>
                      <div className="bg-green-50 rounded-lg p-4">
                        <div className="text-sm font-semibold text-green-800 mb-1">Our Solutions</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            >
              ...
              <div className="text-gray-700 font-medium">Facilities Served</div>
            ...
            >
              ...
              <div className="text-gray-700 font-medium">Odor Reduction</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-heading font-bold text-gray-900 mb-3">Regulatory Expertise</h3>
            ...
            >
              ...
              <h3 className="text-xl font-heading font-bold text-gray-900 mb-3">Proven ROI</h3>
            ...
            >
              ...
              <h3 className="text-xl font-heading font-bold text-gray-900 mb-3">Technical Support</h3>
